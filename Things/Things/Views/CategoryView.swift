...
struct CategoryView: View{
    ...
    func backToBrowse2() {
        editSchema = ProductEditSchema(name: "", category_name: "", quantity: "", photo: nil, audio: nil, video: nil, old_name: "")
        interfaceState = Modes.browse
    ...
    func editProduct(){
        ...
        if let markedProduct = getMarked() {
            editSchema.name = markedProduct.name
            editSchema.photo = markedProduct.photo
            editSchema.old_name = markedProduct.name
        }
                                ...
                                if(fetched == true){
                                    if(productsFound == true) {
                                        ScrollView{
                                            ...
                                            VStack {
                                                ForEach(categoryProducts.indices, id: \.self) {index in
                                                    ...
                                                    Button(
                                                        ...
                                                        Product(name: categoryProducts[index].name, photo: categoryProducts[index].photo ?? nil , quantity: categoryProducts[index].quantity)
                                            ...
                                            //                                            Button(
                                            //                                                action: {
                                            //                                                    if categoriesButtonsBlock == false || lastBlockedName != categoryProducts[index].name {
                                            //                                                        let marked = countMarked()
                                            //
                                            //                                                        if marked == 0 {
                                            //                                                            router.navigate(destination: .categoryProducts(categoryName: categoryProducts[index].name))
                                            //
                                            //                                                        } else if marked == 1 {
                                            //
                                            //                                                            if categoryProducts[index].marked == false {
                                            ...
                                            //                                                }
                                            //                                            ){
                                            //                                                Category(name: categoryProducts[index].name, image: categoryProducts[index].photo, marked: categoryProducts[index].marked)
                                            //
                                            //
                                            //                                            }
                                            //                                            .simultaneousGesture(

...
//    
//    func addProduct(paramsData: CategoryAddSchema, loginStatus: LoginStatus, viewRef: CategoriesView, enableRefreshToken: Bool = true, tokensCopy: TokensSchema? = nil){
//        
...
//    }
//    
//    func editProduct(paramsData: CategoryEditSchema, loginStatus: LoginStatus, viewRef: CategoriesView, enableRefreshToken: Bool = true, tokensCopy: TokensSchema? = nil){
//        
//        let url = "https://things2024.azurewebsites.net/product"
//        
//        var parameters: [String: String] = [:]
...
//    
//    
//    func deleteProduct(paramsData: CategoryDeleteSchema, loginStatus: LoginStatus, viewRef: CategoriesView, enableRefreshToken: Bool = true, tokensCopy: TokensSchema? = nil){
//        
//        let url = "https://things2024.azurewebsites.net/product"
//        
//        var parameters: [String: String] = [:]
...
//    }
//    
//    func getProduct(categoryName: String, loginStatus: LoginStatus, viewRef: CategoryView, enableRefreshToken: Bool = true, tokensCopy: TokensSchema? = nil){
//        
//        let url = "https://things2024.azurewebsites.net/product"
//        
//        var parameters: [String: String] = [:]
...
//                                                loginStatus.refreshToken = refreshToken
//                                            }
//                                            return getProduct(categoryName: categoryName, loginStatus: loginStatus, viewRef: viewRef, enableRefreshToken: false, tokensCopy: TokensSchema(access_token: accessToken, refresh_token: refreshToken))
//
//                                        }else{
//                                            if(fetchedTokens.message != nil){
//                                                let message = fetchedTokens.message!
